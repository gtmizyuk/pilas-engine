...
var Habilidades = (function () {
    function Habilidades(pilas) {
        this.pilas = pilas;
        this._habilidades = [];
        this.vincular("постійно обертатися", RotarConstantemente);
        this.vincular("перетягуватися мишкою", Arrastrable);
        this.vincular("керуватися клавіатурою", MoverConElTeclado);
        this.vincular("рухатися із мишкою", SeguirAlMouse);
        this.vincular("повільно рухатися за мишкою", SeguirAlMouseLentamente);
        this.vincular("коливатися вертикально", OscilarVerticalmente);
        this.vincular("коливатися обертами", OscilarRotacion);
        this.vincular("зникати та з'являтися", OscilarTransparencia);
    }
